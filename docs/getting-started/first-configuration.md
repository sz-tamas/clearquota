...
3. Complete the Google sign-in, then use the dashboard's authentication check. If the check fails, see [authentication problems](../troubleshooting/common-issues.md).
